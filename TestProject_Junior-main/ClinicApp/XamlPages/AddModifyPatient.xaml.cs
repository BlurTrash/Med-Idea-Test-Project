...
namespace ClinicApp.XamlPages
{
    ...
    {
        public DateTime? DisplayStartBirthDate { get; set; } = new DateTime(1900, 01, 01);
        ...
        private async void btnSubmit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                else if(dateOfBirth < DateTime.Parse("01.01.1900")) 
                {
                    status = false;
                    messageBuilder.Append("Дата рождения не может быть меньше 1900г.\n");
                }
                #endregion
                ...
                #endregion
                #region Checking entered birthdate
